...
<html lang="en">
<head>
  <title>Holmgren and Williams gave OKC the push it needed in the third quarter — UrbanPulse</title>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta property="og:title" content="Holmgren and Williams gave OKC the push it needed in the third quarter">
  <meta property="og:description" content="Game 7 turned on Oklahoma City’s burst after halftime, where rim protection, transition pressure, and timely scoring from Chet Holmgren and Jalen Williams broke open the title decider.">
    ...
    <div class="article-container">
      <div class="hero-news">
        <article>
          ...
          <h1 class="hero-title">Holmgren and Williams gave OKC the push it needed in the third quarter</h1>
          <div class="hero-meta">
            <strong>Sarah Jenkins</strong>
            <span>UrbanPulse.com</span>
            <span>June 22, 2025 · 9:45 PM CST</span>
          </div>
          ...
          <div class="hero-image">
            <img src="images/sports/holmgren-williams-third-quarter.jpg" alt="Holmgren and Williams gave OKC the push it needed in the third quarter" loading="lazy">
          </div>
          <p class="hero-summary">Game 7 turned on Oklahoma City’s burst after halftime, where rim protection, transition pressure, and timely scoring from Chet Holmgren and Jalen Williams broke open the title decider.</p>
          <div class="hero-description">Championship games often pivot on one stretch where the tension breaks. In Game 7, that stretch came in the third quarter when Oklahoma City surged and Indiana could not match the pace. Chet Holmgren and Jalen Williams were central to that shift in different but equally important ways.<br><br>Holmgren made the paint feel smaller every possession. His shot contests changed angles, discouraged drives, and helped the Thunder finish defensive possessions cleanly. Williams supplied the offensive counterpart by attacking gaps, pushing transition opportunities, and giving Oklahoma City the extra scoring punch it needed once the game tightened.<br><br>The sequence mattered because it changed the emotional direction of the contest. Indiana had kept the game within reach, but the Thunder’s halftime response brought urgency and clarity. Their young core stopped playing reactively and started forcing the action.<br><br>When the final score settled, the stars received the headlines they deserved. But the title push also belonged to the players who changed the game’s center of gravity before the fourth quarter even arrived. Holmgren and Williams did exactly that.</div>
