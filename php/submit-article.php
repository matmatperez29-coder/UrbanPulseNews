...
<body>
    ...
    <div class="header-container">
      ...
      <div class="header-right">
        ...
        <?php if ($user['role'] === 'admin'): ?>
          ...
          <span class="header-right-divider"></span>
        <?php endif; ?>
        <a href="php/php/logout.php" style="font-size:.85rem;font-weight:700;color:#666;text-decoration:none;">Log Out</a>
      </div>
    </div>
  </header>
  ...
  <div class="submit-page">
    ...
    <div class="submit-box">
      <form method="POST" action="php/php/submit-article.php" id="articleSubmitForm" data-confirm-submit="article">
