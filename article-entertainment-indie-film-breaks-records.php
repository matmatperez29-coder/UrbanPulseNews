...
<html lang="en">
<head>
  <title>Indie Film Breaks Records — UrbanPulse</title>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta property="og:title" content="Indie Film Breaks Records">
  <meta property="og:description" content="Indie Film Breaks Records puts the spotlight on a fast-moving movies story shaping what audiences are watching, talking about, and sharing right now.">
    ...
    <div class="article-container">
      ...
      <div class="hero-news">
        <article>
          ...
          <h1 class="hero-title">Indie Film Breaks Records</h1>
          <div class="hero-meta">
            <strong>Cinema Data</strong>
