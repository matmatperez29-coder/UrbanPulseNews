...
require_once __DIR__ . '/php/php/php/php/auth.php'; // This also starts the session and connects to the DB
      ...
      <div class="hero-news">
        <article>
          ...
          <div class="hero-image">
            <img src="images/sports/wimbledon-historic-finals.jpg" alt="Jannik Sinner and Iga Świątek Rule Wimbledon 2025" loading="lazy">
          </div>
